sap.ui.define([
		...
		return BaseObject.extend("cl.everis.cgr.actvinst.allCGRActvInstAll.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias cl.aquas.development.test.model.ListSelector
			 */
			 ...
			 * @return {cl.aquas.development.test.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
